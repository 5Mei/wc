...
-function(){
if(window.location.href.match(/^https?:\/\/.+?(?:\.m(?:3u8|p4)\?\w+?=|(?:url|id|v|&[^\/]+?|\w+?\.html\?\w+?)[#=\?]https?:\/\/[^\/]+?\.(?:youku|mgtv|sohu|pptv|wasu|1905|iqiyi|le|tudou|qq|yinyuetai|bilibili|fun)\.)/i)){
(function(){var MO=window.MutationObserver||window.WebKitMutationObserver||window.MozMutationObserver;if(MO){var obj=document.querySelectorAll.bind(document);var quanping=obj('iframe[frameborder],video');for(var i=0;i<quanping.length;i++){if(document.querySelectorAll("iframe[frameborder]")[0]){var iframe=document.querySelectorAll("iframe[frameborder]")[0];iframe.setAttribute("data-ad","false");iframe.setAttribute("marginwidth","0");iframe.setAttribute("marginheight","0");iframe.setAttribute("allowfullscreen","allowfullscreen");iframe.setAttribute("mozallowfullscreen","mozallowfullscreen");iframe.setAttribute("msallowfullscreen","msallowfullscreen");iframe.setAttribute("oallowfullscreen","oallowfullscreen");iframe.setAttribute("webkitallowfullscreen","webkitallowfullscreen");iframe.setAttribute("allowTransparency","allowTransparency")}else if(document.querySelectorAll("video")[0]){var video=document.querySelectorAll("video")[0];video.setAttribute("controls","false");video.setAttribute("data-ad","false");video.setAttribute("autoplay","ture");video.setAttribute("crossorigin","anonymous");video.setAttribute("preload","metadata");video.setAttribute("allowfullscreen","ture");video.setAttribute("webkit-playsinline","ture");video.play()}else{}}}else{}})();
...
(function($){var a=window.location.href;if(a.match(/^https?:\/\/.+?(?:url|id|v|&[^\/]+?|\w+?\.html\?\w+?)[#=\?]https?\:\/\/[^\/]+?\.youku\./)){document.title='优酷视频解析中';document.addEventListener('visibilitychange',function(){if(document.hidden){document.title='≥△≤ 已自动隐藏 ≥△≤';clearTimeout(titleTime)}else{document.title='欢迎回来继续看视频';titleTime=setTimeout(function(){document.title='优酷 视频解析中'},2000)}})}else if(a.match(/^https?:\/\/.+?(?:url|id|v|&[^\/]+?|\w+?\.html\?\w+?)[#=\?]https?\:\/\/[^\/]+?\.mgtv\./)){document.title='芒果视频解析中';document.addEventListener('visibilitychange',function(){if(document.hidden){document.title='≥△≤ 已自动隐藏 ≥△≤';clearTimeout(titleTime)}else{document.title='欢迎回来继续看视频';titleTime=setTimeout(function(){document.title='芒果 视频解析中'},2000)}})}else if(a.match(/^https?:\/\/.+?(?:url|id|v|&[^\/]+?|\w+?\.html\?\w+?)[#=\?]https?\:\/\/[^\/]+?\.iqiyi\./)){document.title='奇艺视频解析中';document.addEventListener('visibilitychange',function(){if(document.hidden){document.title='≥△≤ 已自动隐藏 ≥△≤';clearTimeout(titleTime)}else{document.title='欢迎回来继续看视频';titleTime=setTimeout(function(){document.title='奇艺视频解析中'},2000)}})}else if(a.match(/^https?:\/\/.+?(?:url|id|v|&[^\/]+?|\w+?\.html\?\w+?)[#=\?]https?\:\/\/[^\/]+?\.qq\./)){document.title='腾讯视频解析中';document.addEventListener('visibilitychange',function(){if(document.hidden){document.title='≥△≤ 已自动隐藏 ≥△≤';clearTimeout(titleTime)}else{document.title='欢迎回来继续看视频';titleTime=setTimeout(function(){document.title='腾讯视频解析中'},2000)}})}else if(a.match(/^https?:\/\/.+?(?:url|id|v|&[^\/]+?|\w+?\.html\?\w+?)[#=\?]https?\:\/\/[^\/]+?\.sohu\./)){document.title='搜狐视频解析中';document.addEventListener('visibilitychange',function(){if(document.hidden){document.title='≥△≤ 已自动隐藏 ≥△≤';clearTimeout(titleTime)}else{document.title='欢迎回来继续看视频';titleTime=setTimeout(function(){document.title='搜狐视频解析中'},2000)}})}else if(a.match(/^https?:\/\/.+?(?:url|id|v|&[^\/]+?|\w+?\.html\?\w+?)[#=\?]https?\:\/\/[^\/]+?\.le\./)){document.title='乐视视频解析中';document.addEventListener('visibilitychange',function(){if(document.hidden){document.title='≥△≤ 已自动隐藏 ≥△≤';clearTimeout(titleTime)}else{document.title='欢迎回来继续看视频';titleTime=setTimeout(function(){document.title='乐视视频解析中'},2000)}})}else if(a.match(/^https?:\/\/.+?(?:url|id|v|&[^\/]+?|\w+?\.html\?\w+?)[#=\?]https?\:\/\/[^\/]+?\.wasu\./)){document.title='华数视频解析中';document.addEventListener('visibilitychange',function(){if(document.hidden){document.title='≥△≤ 已自动隐藏 ≥△≤';clearTimeout(titleTime)}else{document.title='欢迎回来继续看视频';titleTime=setTimeout(function(){document.title='华数视频解析中'},2000)}})}else if(a.match(/^https?:\/\/.+?(?:url|id|v|&[^\/]+?|\w+?\.html\?\w+?)[#=\?]https?\:\/\/[^\/]+?\.pptv\./)){document.title='PPTV视频解析中';document.addEventListener('visibilitychange',function(){if(document.hidden){document.title='≥△≤ 已自动隐藏 ≥△≤';clearTimeout(titleTime)}else{document.title='欢迎回来继续看视频';titleTime=setTimeout(function(){document.title='PPTV视频解析中'},2000)}})}else if(a.match(/^https?:\/\/.+?(?:url|id|v|&[^\/]+?|\w+?\.html\?\w+?)[#=\?]https?\:\/\/[^\/]+?\.1905\./)){document.title='1905视频解析中';document.addEventListener('visibilitychange',function(){if(document.hidden){document.title='≥△≤ 已自动隐藏 ≥△≤';clearTimeout(titleTime)}else{document.title='欢迎回来继续看视频';titleTime=setTimeout(function(){document.title='1905视频解析中'},2000)}})}else if(a.match(/^https?:\/\/.+?(?:url|id|v|&[^\/]+?|\w+?\.html\?\w+?)[#=\?]https?\:\/\/[^\/]+?\.tudou\./)){document.title='土豆视频解析中';document.addEventListener('visibilitychange',function(){if(document.hidden){document.title='≥△≤ 已自动隐藏 ≥△≤';clearTimeout(titleTime)}else{document.title='欢迎回来继续看视频';titleTime=setTimeout(function(){document.title='土豆视频解析中'},2000)}})}else if(a.match(/^https?:\/\/.+?(?:url|id|v|&[^\/]+?|\w+?\.html\?\w+?)[#=\?]https?\:\/\/[^\/]+?\.fun\./)){document.title='风行视频解析中';document.addEventListener('visibilitychange',function(){if(document.hidden){document.title='≥△≤ 已自动隐藏 ≥△≤';clearTimeout(titleTime)}else{document.title='欢迎回来继续看视频';titleTime=setTimeout(function(){document.title='风行视频解析中'},2000)}})}else if(a.match(/^https?:\/\/.+?(?:url|id|v|&[^\/]+?|\w+?\.html\?\w+?)[#=\?]https?\:\/\/[^\/]+?\.acfun\./)){document.title='A站视频解析中';document.addEventListener('visibilitychange',function(){if(document.hidden){document.title='≥△≤ 已自动隐藏 ≥△≤';clearTimeout(titleTime)}else{document.title='欢迎回来继续看视频';titleTime=setTimeout(function(){document.title='A站视频解析中'},2000)}})}else if(a.match(/^https?:\/\/.+?(?:url|id|v|&[^\/]+?|\w+?\.html\?\w+?)[#=\?]https?\:\/\/[^\/]+?\.bilibili\./)){document.title='B站视频解析中';document.addEventListener('visibilitychange',function(){if(document.hidden){document.title='≥△≤ 已自动隐藏 ≥△≤';clearTimeout(titleTime)}else{document.title='欢迎回来继续看视频';titleTime=setTimeout(function(){document.title='B站视频解析中'},2000)}})}else if(a.match(/^https?:\/\/.+?(?:url|id|v|&[^\/]+?|\w+?\.html\?\w+?)[#=\?]https?\:\/\/[^\/]+?\.yinyuetai\./)){document.title='音乐台视频解析中';document.addEventListener('visibilitychange',function(){if(document.hidden){document.title='≥△≤ 已自动隐藏 ≥△≤';clearTimeout(titleTime)}else{document.title='欢迎回来继续看视频';titleTime=setTimeout(function(){document.title='音乐台视频解析中'},2000)}})}})();
...
},{name:ggb+aac+++ffb+"空间",url:"https://www.urlkj.com/?url="
...
},{name:ggc+bbe+++ffb+"89",url:"http://www.ka61b.cn/jx.php?url="
...
sx();var b=window.location.href,a=document.location.toString().split("/id_"),c=a[1].indexOf("/");a=a[1].substring(c);-1!=a.indexOf(".")&&(a=a.split(".")[0]);(function(b){document.getElementById(b)&&(document.getElementById(b).innerHTML='<iframe id="jiangxiaobai" style="'+style+'" width="100%" height="100%"'+qp+'src="'+https[num].url+'http://v.youku.com/v_show/id_'+a+'.html"></iframe>')})("player");
}else if(b.match(/^https?:\/\/m\.youku\.com\/(?:alipay_)?video\/id_[^\.]+?\.html/i)){
sx();var b=window.location.href,a=document.location.toString().split("://"),c=a[1].indexOf("/");a=a[1].substring(c);-1!=a.indexOf(".")&&(a=a.split(".")[0]);(function(b){document.getElementById(b)&&(document.getElementById(b).innerHTML='<iframe id="jiangxiaobai" style="'+style+'" width="100%" height="100%"'+qp+'src="'+https[num].url+'http://m.youku.com'+a+'.html"></iframe>')})("player");
}else if(b.match(/(?:^https?:\/\/m\.mgtv\.com\/b\/)/i)){
sx();var c=window.location.href,a=document.location.toString().split("//"),b=a[1].indexOf("/");a=a[1].substring(b);-1!=a.indexOf(".")&&(a=a.split(".")[0]);(function(b){document.querySelectorAll(b)[0]&&(document.querySelectorAll(b)[0].innerHTML='<iframe style="'+style+'" width="100%" height="100%"'+qp+'src="'+https[num].url+'http://www.mgtv.com'+a+'.html"></iframe>')})('.video-area');
}else if(b.match(/^https?:\/\/m\.v\.qq\.com\/(?:play\.html|(?:x\/)?cover\/\w{1,2}\/[^\.]+?\.html)(?![^\/]*?cid=)[^\/]+?&vid=/i)){
sx();var c=window.location.href,a=document.location.toString().split("/cover/"),b=a[1].indexOf("/");a=a[1].substring(c);-1!=a.indexOf(".")&&(a=a.split(".")[0]);var c=window.location.href,e=document.location.toString().split("&vid="),c=e[1].indexOf("&vid=");e=e[1].substring(c);-1!=e&&(e=e);(function(b){document.querySelectorAll(b)[0]&&(document.querySelectorAll(b)[0].innerHTML='<iframe id="jiangxiaobai" style="'+style+'" width="100%" height="100%"'+qp+'src="'+https[num].url+'http://v.qq.com/x/cover/'+a+'/'+e+'.html"></iframe>')})('.site_player');
}else if(b.match(/^https?:\/\/m\.v\.qq\.com\/(?:play\.html|(?:x\/)?cover\/\w{1,2}\/[^\.]+?\.html)[^\/]*?cid=[^\/]+?&vid=(?:[^\/]+?&\w+?=|\w+$)/i)){
sx();var c=window.location.href,a=document.location.toString().split("?cid="),b=a[1].indexOf("cid=");a=a[1].substring(c);-1!=a.indexOf("&")&&(a=a.split("&")[0]);var c=window.location.href,e=document.location.toString().split("&vid="),b=a[1].indexOf("vid=");e=e[1].substring(c);-1!=e.indexOf("&")&&(e=e.split("&")[0]);(function(b){document.querySelectorAll(b)[0]&&(document.querySelectorAll(b)[0].innerHTML='<iframe id="jiangxiaobai" style="'+style+'" width="100%" height="100%"'+qp+'src="'+https[num].url+'http://v.qq.com/x/cover/'+a+'/'+e+'.html"></iframe>')})('.site_player');
}else if(b.match(/^https?:\/\/m\.v\.qq\.com\/(?:play\.html|(?:x\/)?cover\/\w{1,2}\/[^\.]+?\.html)[^\/]+?cid=[^\/]+?&vid=$/i)){
sx();var c=window.location.href,a=document.location.toString().split("cid="),b=a[1].indexOf("cid=");a=a[1].substring(c);-1!=a.indexOf("&")&&(a=a.split("&")[0]);(function(b){document.querySelectorAll(b)[0]&&(document.querySelectorAll(b)[0].innerHTML='<iframe id="jiangxiaobai" style="'+style+'" width="100%" height="100%"'+qp+'src="'+https[num].url+'http://v.qq.com/x/cover/'+a+'.html"></iframe>')})('.site_player');
}else if(b.match(/^https?:\/\/m\.v\.qq\.com\/(?:x\/)?cover\/\w{1,2}\/[^\.]+?\.html(?![^\/]*?cid=)$/i)){
sx();var c=window.location.href,a=document.location.toString().split("/cover/"),b=a[1].indexOf("/");a=a[1].substring(c);-1!=a.indexOf(".")&&(a=a.split(".")[0]);(function(b){document.querySelectorAll(b)[0]&&(document.querySelectorAll(b)[0].innerHTML='<iframe id="jiangxiaobai" style="'+style+'" width="100%" height="100%"'+qp+'src="'+https[num].url+'http://v.qq.com/x/cover/'+a+'.html"></iframe>')})('.site_player');
}else if(b.match(/^https?:\/\/m\.v\.qq\.com\/(?:x\/)?cover\/\w{1,2}\/[^\.]+?\.html(?![^\/]*?cid=)\?vid=/i)){
sx();var c=window.location.href,a=document.location.toString().split("/cover/"),b=a[1].indexOf("/");a=a[1].substring(c);-1!=a.indexOf(".")&&(a=a.split(".")[0]);var c=window.location.href,e=document.location.toString().split("?vid="),c=e[1].indexOf("?vid=");e=e[1].substring(c);-1!=e&&(e=e);(function(b){document.querySelectorAll(b)[0]&&(document.querySelectorAll(b)[0].innerHTML='<iframe id="jiangxiaobai" style="'+style+'" width="100%" height="100%"'+qp+'src="'+https[num].url+'http://v.qq.com/x/cover/'+a+'/'+e+'.html"></iframe>')})('.site_player');
}else if(b.match(/^https?:\/\/m\.pptv\.com\/show\//i)){
sx();var b=window.location.href,a=document.location.toString().split("/show/"),c=a[1].indexOf("/show/");a=a[1].substring(c);-1!=a.indexOf(".")&&(a=a.split(".")[0]);(function(b){document.getElementById(b)&&(document.getElementById(b).innerHTML='<iframe id="jiangxiaobai" style="'+style+'" width="100%" height="100%"'+qp+'src="'+https[num].url+'http://v.pptv.com/show/'+a+'.html"></iframe>')})("playerbox");
}else if(b.match(/^https?:\/\/vip\.1905\.com\/play\//i)){
sx();var b=window.location.href,a=document.location.toString().split("/play/"),c=a[1].indexOf("/play/");a=a[1].substring(c);-1!=a.indexOf(".")&&(a=a.split(".")[0]);if(document.getElementById("playBox")){(function(b){document.getElementById(b)&&(document.getElementById(b).innerHTML='<iframe id="jiangxiaobai" style="'+style+'" width="100%" height="100%"'+qp+'src="'+https[num].url+'http://vip.1905.com/play/'+a+'.html"></iframe>')})("playBox");}else if(document.getElementById("player")){(function(b){document.getElementById(b)&&(document.getElementById(b).innerHTML='<iframe id="jiangxiaobai" style="'+style+'" width="100%" height="100%"'+qp+'src="'+https[num].url+'http://vip.1905.com/play/'+a+'.html"></iframe>')})("player");};
}else if(b.match(/^https?:\/\/m\.tv\.sohu\.com\/v/i)){
sx();var c=window.location.href,a=document.location.toString().split("//"),b=a[1].indexOf("/");a=a[1].substring(b);-1!=a.indexOf(".")&&(a=a.split(".")[0]);(function(b){document.querySelectorAll(b)[0]&&(document.querySelectorAll(b)[0].innerHTML='<iframe id="jiangxiaobai" style="'+style+'" width="100%" height="100%"'+qp+'src="'+https[num].url+'http://m.tv.sohu.com'+a+'.shtml"></iframe>')})('.x-player');
}else if(b.match(/^https?:\/\/m\.tv\.sohu\.com\/album\/s/i)){
sx();var c=window.location.href,a=document.location.toString().split("/album/s"),b=a[1].indexOf("/album/s");a=a[1].substring(b);-1!=a.indexOf(".")&&(a=a.split(".")[0]);(function(b){document.querySelectorAll(b)[0]&&(document.querySelectorAll(b)[0].innerHTML='<iframe id="jiangxiaobai" style="'+style+'" width="100%" height="100%"'+qp+'src="'+https[num].url+'http://film.sohu.com/album/'+a+'.html"></iframe>')})('.x-player');
}else if(b.match(/^https?:\/\/m\.tv\.sohu\.com\/album\//i)){
sx();var c=window.location.href,a=document.location.toString().split("/album/"),b=a[1].indexOf("/album/");a=a[1].substring(b);-1!=a.indexOf(".")&&(a=a.split(".")[0]);(function(b){document.querySelectorAll(b)[0]&&(document.querySelectorAll(b)[0].innerHTML='<iframe id="jiangxiaobai" style="'+style+'" width="100%" height="100%"'+qp+'src="'+https[num].url+'http://film.sohu.com/album/'+a+'.html"></iframe>')})('.x-player');
...
function qq(){
(function(b){document.querySelectorAll(b)[0]&&(document.querySelectorAll(b)[0].innerHTML='')})('.site_player');
};
function pptv(){
...
if(b.match(/^https?:\/\/m\.youku\.com\/(?:alipay_)?video\/id_[^==]+?==\.html/i)){
sx();var b=window.location.href,a=document.location.toString().split("/id_"),b=a[1].indexOf("/");a=a[1].substring(b);-1!=a.indexOf(".")&&(a=a.split(".")[0]);youku();window.open(http[num].url+"http://v.youku.com/v_show/id_"+a+".html","bkmk_popup","allowfullscreen=true,allowfullscreen=allowfullscreen,esizable=1,scrollbars=1,toolbar=0,status=0,width=1050,height=600,left="+(screen.availWidth-1050)/2+",top="+(screen.availHeight-600)/2);
}else if(b.match(/^https?:\/\/m\.youku\.com\/(?:alipay_)?video\/id_[^\.]+?\.html/i)){
sx();var b=window.location.href,a=document.location.toString().split("://"),b=a[1].indexOf("/");a=a[1].substring(b);-1!=a.indexOf(".")&&(a=a.split(".")[0]);youku();window.open(http[num].url+"http://m.youku.com"+a+".html","bkmk_popup","allowfullscreen=true,allowfullscreen=allowfullscreen,esizable=1,scrollbars=1,toolbar=0,status=0,width=1050,height=600,left="+(screen.availWidth-1050)/2+",top="+(screen.availHeight-600)/2);
}else if(b.match(/^https?:\/\/m\.mgtv\.com\/b\//i)){
sx();var b=window.location.href,a=document.location.toString().split("//"),b=a[1].indexOf("/");a=a[1].substring(b);-1!=a.indexOf(".")&&(a=a.split(".")[0]);mgtv();window.open(http[num].url+"http://www.mgtv.com"+a+".html","bkmk_popup","allowfullscreen=true,allowfullscreen=allowfullscreen,esizable=1,scrollbars=1,toolbar=0,status=0,width=1050,height=600,left="+(screen.availWidth-1050)/2+",top="+(screen.availHeight-600)/2);
}else if(b.match(/^https?:\/\/m\.v\.qq\.com\/(?:play\.html|(?:x\/)?cover\/\w{1,2}\/[^\.]+?\.html)(?![^\/]*?cid=)[^\/]+?&vid=/i)){
sx();var c=window.location.href,a=document.location.toString().split("/cover/"),b=a[1].indexOf("/");a=a[1].substring(c);-1!=a.indexOf(".")&&(a=a.split(".")[0]);var c=window.location.href,e=document.location.toString().split("&vid="),c=e[1].indexOf("&vid=");e=e[1].substring(c);-1!=e&&(e=e);qq();window.open(http[num].url+"http://v.qq.com/x/cover"+a+"/"+e+".html","bkmk_popup","allowfullscreen=true,allowfullscreen=allowfullscreen,esizable=1,scrollbars=1,toolbar=0,status=0,width=1050,height=600,left="+(screen.availWidth-1050)/2+",top="+(screen.availHeight-600)/2);
}else if(b.match(/^https?:\/\/m\.v\.qq\.com\/(?:play\.html|(?:x\/)?cover\/\w{1,2}\/[^\.]+?\.html)[^\/]*?cid=[^\/]+?&vid=(?:[^\/]+?&\w+?=|\w+$)/i)){
sx();var c=window.location.href,a=document.location.toString().split("?cid="),b=a[1].indexOf("cid=");a=a[1].substring(c);-1!=a.indexOf("&")&&(a=a.split("&")[0]);var c=window.location.href,e=document.location.toString().split("&vid="),b=a[1].indexOf("vid=");e=e[1].substring(c);-1!=e.indexOf("&")&&(e=e.split("&")[0]);qq();window.open(http[num].url+"http://v.qq.com/x/cover/"+a+"/"+e+".html","bkmk_popup","allowfullscreen=true,allowfullscreen=allowfullscreen,esizable=1,scrollbars=1,toolbar=0,status=0,width=1050,height=600,left="+(screen.availWidth-1050)/2+",top="+(screen.availHeight-600)/2);
}else if(b.match(/^https?:\/\/m\.v\.qq\.com\/(?:play\.html|(?:x\/)?cover\/\w{1,2}\/[^\.]+?\.html)[^\/]+?cid=[^\/]+?&vid=$/i)){
...
sx();var b=window.location.href,a=document.location.toString().split("/show/"),b=a[1].indexOf("/show/");a=a[1].substring(b);-1!=a.indexOf(".")&&(a=a.split(".")[0]);pptv();window.open(http[num].url+"http://v.pptv.com/show/"+a+".html","bkmk_popup","allowfullscreen=true,allowfullscreen=allowfullscreen,esizable=1,scrollbars=1,toolbar=0,status=0,width=1050,height=600,left="+(screen.availWidth-1050)/2+",top="+(screen.availHeight-600)/2);
}else if(b.match(/^https?:\/\/vip\.1905\.com\/play\//i)){
zt();sx();var b=window.location.href,a=document.location.toString().split("/play/"),b=a[1].indexOf("/play/");a=a[1].substring(b);-1!=a.indexOf(".")&&(a=a.split(".")[0]);(function(b){document.getElementById(b)&&(document.getElementById(b).innerHTML='<img src="'+jxbimg+'"style="width:100%;height:100%"></img>')})("playBox");window.open(http[num].url+"http://vip.1905.com/play/"+a+".html","bkmk_popup","allowfullscreen=true,allowfullscreen=allowfullscreen,esizable=1,scrollbars=1,toolbar=0,status=0,width=1050,height=600,left="+(screen.availWidth-1050)/2+",top="+(screen.availHeight-600)/2);
}else if(b.match(/^https?:\/\/m\.tv\.sohu\.com\/v/i)){
sx();var b=window.location.href,a=document.location.toString().split("//"),b=a[1].indexOf("/");a=a[1].substring(b);-1!=a.indexOf(".")&&(a=a.split(".")[0]);sohudsj();window.open(http[num].url+"http://m.tv.sohu.com"+a+".shtml","bkmk_popup","allowfullscreen=true,allowfullscreen=allowfullscreen,esizable=1,scrollbars=1,toolbar=0,status=0,width=1050,height=600,left="+(screen.availWidth-1050)/2+",top="+(screen.availHeight-600)/2);
}else if(b.match(/^https?:\/\/m\.tv\.sohu\.com\/album\/s/i)){
sx();var b=window.location.href,a=document.location.toString().split("/album/s"),b=a[1].indexOf("/album/s");a=a[1].substring(b);-1!=a.indexOf(".")&&(a=a.split(".")[0]);sohudsj();window.open(http[num].url+"http://film.sohu.com/album/"+a+".shtml","bkmk_popup","allowfullscreen=true,allowfullscreen=allowfullscreen,esizable=1,scrollbars=1,toolbar=0,status=0,width=1050,height=600,left="+(screen.availWidth-1050)/2+",top="+(screen.availHeight-600)/2);
}else if(b.match(/^https?:\/\/m\.tv\.sohu\.com\/album\//i)){
sx();var b=window.location.href,a=document.location.toString().split("/album/"),b=a[1].indexOf("/album/");a=a[1].substring(b);-1!=a.indexOf(".")&&(a=a.split(".")[0]);sohudsj();window.open(http[num].url+"http://film.sohu.com/album/"+a+".shtml","bkmk_popup","allowfullscreen=true,allowfullscreen=allowfullscreen,esizable=1,scrollbars=1,toolbar=0,status=0,width=1050,height=600,left="+(screen.availWidth-1050)/2+",top="+(screen.availHeight-600)/2);
}else if(b.match(/^https?:\/\/m\.film\.sohu\.com\/album\//i)){
sx();var b=window.location.href,a=document.location.toString().split("//"),b=a[1].indexOf("/");a=a[1].substring(b);-1!=a.indexOf(".")&&(a=a.split(".")[0]);sohudy();window.open(http[num].url+"http://film.sohu.com"+a+".html","bkmk_popup","allowfullscreen=true,allowfullscreen=allowfullscreen,esizable=1,scrollbars=1,toolbar=0,status=0,width=1050,height=600,left="+(screen.availWidth-1050)/2+",top="+(screen.availHeight-600)/2);
}else if(b.match(/^https?:\/\/m\.le\.com\/vplay_/i)){
sx();var b=window.location.href,a=document.location.toString().split("/vplay_"),b=a[1].indexOf("/vplay_");a=a[1].substring(b);-1!=a.indexOf(".")&&(a=a.split(".")[0]);le();window.open(http[num].url+"http://www.le.com/ptv/vplay/"+a+".html","bkmk_popup","allowfullscreen=true,allowfullscreen=allowfullscreen,esizable=1,scrollbars=1,toolbar=0,status=0,width=1050,height=600,left="+(screen.availWidth-1050)/2+",top="+(screen.availHeight-600)/2);
}else if(b.match(/^https?:\/\/m\.iqiyi\.com\/(?:v_|dianying\/)/i)){
...
sx();var b=window.location.href,a=document.location.toString().split("?mid="),b=a[1].indexOf("?mid=");a=a[1].substring(b);-1!=a&&(a=a);fun();window.open(http[num].url+"http://www.fun.tv/vplay/g-"+a+"/","bkmk_popup","allowfullscreen=true,allowfullscreen=allowfullscreen,esizable=1,scrollbars=1,toolbar=0,status=0,width=1050,height=600,left="+(screen.availWidth-1050)/2+",top="+(screen.availHeight-600)/2);
}else if(b.match(/^https?:\/\/v\.youku\.com\/v_show\/id_/i)){
...
}else if(b.match(/^https?:\/\/m\.v\.qq\.com\//i)){
